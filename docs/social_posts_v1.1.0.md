# Social Media Promo Posts — Panduan Umrah v1.1.0

## X (Twitter) Thread — 3 Tweets

---

### Tweet 1 — Personal backstory + hook
...
1️⃣ APK terus (paling senang — install macam biasa):
   https://github.com/dominggo/13_umrahguide/releases
   → download app-release.apk

2️⃣ Google Play Store (internal tester):
